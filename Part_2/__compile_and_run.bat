...
:: wsl g++ -o singlegrid singlegrid.cpp monte_carlo.cpp rand_utils.cpp vector_utils.cpp
...
wsl ./temp_sweep  128 2.0 2.77.0 32 ./results/temp_sweep_128_nearcrit.dat 100000 1000 1
